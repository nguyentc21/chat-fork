...
export default class Message extends React.Component {
    ...
    render() {
        const { currentMessage, nextMessage, position, containerStyle, ignoreRightAvatar } = this.props;
        if (currentMessage) {
          ...
          {currentMessage.system ? (this.renderSystemMessage()) : (<View style={[
              ...
              {this.renderBubble()}
              {(this.props.position === 'right' && !ignoreRightAvatar) ? this.renderAvatar() : null}
            </View>)}
        </View>);
        }
        return null;
