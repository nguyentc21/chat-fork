...
export default class Bubble extends React.Component {
    constructor() {
        ...
        this.onLongPress = () => {
            ...
            if (this.props.onLongPress) {
                ...
                const { optionTitles, optionActions } = this.props;
                ...
                this.context.actionSheet().showActionSheetWithOptions({
                    ...
                    switch (buttonIndex) {
                        case 0:
                            optionActions[0](currentMessage)
                            break;
                        case 1:
                            optionActions[1](currentMessage)
                            break;
                        case 2:
                            optionActions[2](currentMessage)
                            break;
                        case 3:
                            optionActions[3](currentMessage)
                            break;
                        case 4:
                            optionActions[4](currentMessage)
                            break;
                        case 5:
                            optionActions[5](currentMessage)
                            break;
                        default:
                            break;
                    }
    ...
    renderMessageImage() {
        if (this.props.currentMessage && this.props.currentMessage.image) {
            ...
            return <MessageImage {...messageImageProps} onLongPress={this.onLongPress} />;
        }
        return null;
    }
    renderMessageVideo() {
    ...
    renderUsername() {
        const { currentMessage, user, hideUsername } = this.props;
    ...
    renderMessageIcon() {
        if (!!this.props.renderMessageIcon) {
            return this.props.renderMessageIcon(this.props)
        }
    }
    render() {
        ...
        return (<View style={[
            ...
            <View style={[
                position === 'left' ? { marginRight: 60 } : { marginLeft: 60 },
