...
export default class InputToolbar extends React.Component {
    ...
    renderAdditionBtn() {
        if (!!this.props.renderAdditionBtn) {
            return this.props.renderAdditionBtn()
        }
    }
    renderSend() {
    ...
    renderQuotePreview() {
        if (this.props.renderQuotePreview) {
            return this.props.renderQuotePreview()
        }
    }
    render() {
        return (<View style={[
            ...
            this.props.inputToolbarStyle
        ]}>
            {this.renderQuotePreview()}
            <View style={[styles.primary, this.props.primaryStyle]}>
                {this.renderActions()}
                {this.renderComposer()}
                {this.renderAdditionBtn()}
                {this.renderSend()}
            </View>
